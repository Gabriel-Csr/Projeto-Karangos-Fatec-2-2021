...
// import do homepage, tollbar e do botão
import homepage from '../some-cars.png'
...
// criação de uma função no qual faz a figura anteriormente false, fica visivel (true) com a ação do clique, e um else para retornar para false ao repetir o clique
      function clique (){
          if(figVisible===false){
 ...
 // no return, criação da toolbar e atribuindo caracteristicas ao botão    
    return (
        <>
        ...
        >
          Surpresa!
            ...
            <div className={classes.div}>
                <img src = { homepage} alt="Carros antigos" style={{opacity: figVisible ? '1' : '0', height: figVisible ? '591px': '0'}}
                 className= {classes.figura}/> 
            </div>
    
         
        </>  
        // inserção de um className = classes.figura para aplicar o css anteriormente definido
